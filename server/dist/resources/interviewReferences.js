...
exports.INTERVIEW_REFERENCE_DOCS = void 0;
exports.INTERVIEW_REFERENCE_DOCS = [
    {
        ...
        content: "The resource guide organizes preparation into Junior, Mid, Senior, and Architect tracks across JavaScript, React, Preact, and frontend system design.",
    },
    {
        id: "pdf-js-path",
        sourceType: "pdf",
        ...
        content: "JavaScript preparation grows from MDN and JavaScript.info fundamentals to advanced engine and performance resources such as v8.dev and web.dev.",
    },
    {
        id: "pdf-react-path",
        sourceType: "pdf",
        ...
        content: "React progression starts with core React docs, then moves into patterns, testing, and performance profiling. Architect-level preparation includes Next.js, Storybook, and large-scale frontend patterns.",
    },
    {
        id: "pdf-preact-path",
        sourceType: "pdf",
        ...
        content: "Preact preparation should cover React differences, Preact Signals, and bundle size trade-offs for performance-sensitive storefronts.",
    },
    {
        ...
        content: "Frontend system design practice should include large-scale architecture, micro-frontends, observability and RUM, performance budgets, and communicating trade-offs with clear diagrams.",
    },
    {
        ...
        content: "Suggested sequence: core browser and JS fundamentals, component architecture and design systems, large-scale app patterns, performance at scale, system-design practice, and CI/CD plus monorepo strategy.",
    },
    {
        ...
        content: "React preparation should emphasize fundamentals (components, props/state, lifecycle/hooks, JSX, reconciliation) and applied topics like context, memoization, rendering behavior, and performance trade-offs.",
    },
    {
        ...
        content: "React interview loops often combine conceptual questions and coding tasks around component design, hooks, state ownership, forms, async data, and render optimization.",
    },
    {
        ...
        content: "Core React topics include JSX transformation, props vs state, controlled components, hooks (useState/useEffect/useContext/useReducer), reconciliation, and avoiding unnecessary re-renders.",
    },
    {
        ...
        content: "React interviews should be calibrated by seniority while covering fundamentals, practical debugging, component architecture, data flow clarity, and performance-informed decisions.",
    },
    {
        ...
        content: "React preparation should include basic-to-advanced progression with strong command of hooks, forms, component patterns, and practical use-case discussions.",
    },
    {
        ...
        content: "Core JavaScript interviews should rotate through closures, lexical scope, hoisting/TDZ, this binding, prototypes, promises/async-await, event loop, equality semantics, modules, and functional patterns.",
    },
    {
        ...
        content: "JavaScript interviews usually combine language fundamentals with practical coding and debugging: scope, closures, prototypes, async behavior, and modern ES features.",
    },
    {
        id: "web-js-gfg-core",
        sourceType: "web",
        ...
        content: "Core JavaScript preparation should cover var/let/const, hoisting, lexical scope, call/apply/bind, promises, event-loop behavior, strict mode, and practical examples for each concept.",
    },
    {
        ...
        content: "The get-started hub outlines end-to-end onboarding for Commerce storefront development, linking setup, storefront creation, drop-ins, and deployment-oriented next steps.",
    },
    {
    ...
    },
    {
        ...
        content: "Drop-in components are full-featured commerce experiences. Commerce blocks integrate drop-ins in Edge Delivery Services. Content blocks support non-commerce page layout and content.",
    },
    {
        ...
        content: "Drop-ins are integrated through initializer scripts and rendered containers. Questions should test setup correctness, import structure, and extension/customization boundaries.",
    },
    {
        ...
        content: "Adobe Commerce drop-ins require eligible licensing. Interview answers should reflect awareness of eligibility and release/version governance when discussing production adoption.",
    },
    {
        id: "web-multistore",
        sourceType: "web",
        ...
        content: "Multistore can be implemented via multiple domains or subfolder root paths, sharing code while isolating locale, region, brand configuration, and data boundaries.",
    },
    {
        ...
        content: "After initial setup, teams should standardize preview/publish workflow, local customization process, and migration toward advanced configuration service capabilities.",
    },
];
